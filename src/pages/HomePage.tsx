...
import BackgroundImg from '../assets/svg/route.svg';
...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-center bg-no-repeat bg-cover relative" style={{backgroundImage: `url(${BackgroundImg})`}}>

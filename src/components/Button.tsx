  ...
  if (variant === "primary") {
    return (
      <button
        ...
        {...props}
      >
        <span className="w-full h-full flex items-center justify-center gap-3 p-6 md:p-8 bg-[#B931FC] text-white rounded-[14px] bg-gradient-to-t from-[#a62ce2] to-[#c045fc] font-bold text-lg md:text-xl">
